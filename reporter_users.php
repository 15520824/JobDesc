...
jobdesc.reporter_users.generateData = function(host) {
    var data, header;
    DOMElement.removeAllChildren(host.category_container);
};

jobdesc.reporter_users.init = function(host, mode) {
    host.database = {};
    ...
    Promise.all(promiseAll).then(function() {
                    ...
                    child: [{
                        ...
                        },
                        {
                            ...
                            on: {
                                click: function(host) {
                                    return function() {
                                        var temp1 = jobdescui.formAddUser(host);
        ...
        switch (mode) {
            case 1:
                jobdesc.reporter_users_information.init(mainFrame.$viewport, host)
                break;
            case 2:
