<?php
    function write_reporter_positions_libary_script(){
?>
<script type="text/javascript">
"use strict";

jobdesc.reporter_positions_libary.generateData = function(host) {
    var data, header;
    DOMElement.removeAllChildren(host.category_container);
};

jobdesc.reporter_positions_libary.init = function(host, mode) {
    host.database = {};
    ...
    var promiseAll = [];
    promiseAll.push(data_module.positionsLibaryList.load());
    Promise.all(promiseAll).then(function() {
        ...
        switch (mode) {
            case 1:
                jobdesc.reporter_positions_libary_information.init(container, host)
                break;
            case 2:
